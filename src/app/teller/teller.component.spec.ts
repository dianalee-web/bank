...
describe("TellerComponent", () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.overrideComponent(TellerComponent, {
  ...
  describe("teller.transactions", () => {
    ...
    it("should record transaction history on the service", () => {
      const numOfTransactions = componentService.account.transactions.length;
      component.value = 1;
      component.deposit();
      let numNewTransactions =
        componentService.account.transactions.length - numOfTransactions;
